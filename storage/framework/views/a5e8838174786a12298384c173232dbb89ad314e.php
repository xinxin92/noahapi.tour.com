...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            <span class="logo-lg"><b>运营后台</b>管理系统</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a><span>您好！<?php echo e($master['master_name']); ?></span></a>
                    </li>
                    <li>
        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <?php foreach($menus as $menu): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa <?php echo e(!empty($menu['icon'])?$menu['icon']:'fa-circle-o'); ?>"></i>
                            <span><?php echo e($menu['action_name']); ?></span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php foreach($menu['children'] as $child): ?>
                                <li>
                                    <a href="#" url="<?php echo e($child['url']); ?>">
                                        <i class="fa fa-circle-o"></i> <?php echo e($child['action_name']); ?>
    ...
    <div class="content-wrapper" style="-webkit-overflow-scrolling: touch;overflow-y: scroll;">
        <iframe style="width:100%;min-height:900px;" scrolling="auto" frameborder="0" class="" id="pagebody_iframe"
                src="/home/master"></iframe>
    </div>
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2012-2017 <a href="http://www.xinxinblog.com">鑫鑫博客</a>.</strong> All rights
        reserved.
    </footer>

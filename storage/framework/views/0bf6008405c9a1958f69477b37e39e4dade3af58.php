        ...
        <div class="col-xs-12">
            <div class="box-body table-responsive">
                <table class="table table-hover table-bordered table-striped">
                    <tr class="success">
                        <input type="text" id="type" class="hidden" value="<?php echo e($type); ?>" />
                        <th align="right" width="20%" class="text-center">标题<span class="text-red">*</span>:</th>
                        <td width="80%"><input type="text" name="title" class="form-control" value="<?php if($type == 'edit'): ?><?php echo e($articleInfo['title']); ?><?php endif; ?>" /></td>
                    </tr>
                    ...
                    <tr class="success">
                        ...
                        <td width="80%"><textarea name="introduction" class="form-control" ><?php if($type == 'edit'): ?><?php echo e($articleInfo['introduction']); ?><?php endif; ?></textarea></td>
                    </tr>
                    <tr class="success">
                        <th align="right" width="20%" class="text-center">封面<span class="text-red">*</span>:</th>
                        <td width="80%">
                            <img src="<?php if($type == 'edit'): ?><?php echo e($articleInfo['pic_url']); ?><?php endif; ?>" width="100px" id="file_src_cover" />
                        ...
                        <table class="table table-hover table-bordered table-striped" id="content<?php echo e(++$key); ?>">
                            ...
                            <tr class="success">
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e($content['pic_url']); ?>" width="100px" id="file_src_content<?php echo e($key); ?>" />
                                        <input type="hidden" name="content_pic[]" id="file_name_content<?php echo e($key); ?>" /><br />
